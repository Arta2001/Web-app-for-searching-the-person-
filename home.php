		...
		<div class="size1 p-l-15 p-r-15 p-t-30 p-b-50">
			...
			<div class="wsize1 m-lr-auto">
				...
				<form class="w-full flex-w flex-c-m validate-form">
					...
					<div class="wrap-input100 validate-input m-b-20" data-validate = "Nuk keni shenuar formtin e duhur te numrit.">
						<input class="input100 placeholder0 m1-txt1" type="tel" name="searchTerm" placeholder="Numri i telefonit" >
						<span class="focus-input100"></span>
					</div>
					
					<a href="lista.php"  data-toggle="tooltip"><button type="button" class="flex-c-m size3 m1-txt2 how-btn1 trans-04 m-b-20">Kerko</button></a>  
